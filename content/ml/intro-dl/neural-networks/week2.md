...
![](/assets/images/ml/intro_dl/neural_networks/0003.png)
...
![](/assets/images/ml/intro_dl/neural_networks/0004.png)
...
<figure>
  <img src="/assets/images/ml/intro_dl/neural_networks/0005.svg"></img>
  <figcaption>Exponential function $y = e^x$ (source: Wikipedia</figcaption>
</figure>
...
![](/assets/images/ml/intro_dl/neural_networks/sigmoid.png){: .center}
...
![](/assets/images/ml/intro_dl/neural_networks/Logarithm_plots.png){: .center}
...
![](/assets/images/ml/intro_dl/neural_networks/Untitled 3.png)
...
!!! TIP
    ...
    <mark class="y"> Remember $d$ is used for derivative whereas $\partial$ is used to denote partial derivative</mark> when the function we want to derivate has multiple other variables (which are considered constant at the time we are finding the derivative).


## Derivatives

<iframe width="999" height="400" src="https://www.youtube.com/embed/9vKqVkMQHKk" title="The paradox of the derivative | Chapter 2, Essence of calculus" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<figure>
  <img src="/assets/images/ml/intro_dl/neural_networks/0009.png"></img>
...
![](/assets/images/ml/intro_dl/neural_networks/Untitled 5.png)
...
<iframe width="999" height="400" src="https://www.youtube.com/embed/IHZwWFHWa-w" title="Gradient descent, how neural networks learn | Chapter 2, Deep learning" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
![](/assets/images/ml/intro_dl/neural_networks/Untitled 6.png)

![](/assets/images/ml/intro_dl/neural_networks/20210502_170324.jpg)

<figure>
  <img src="/assets/images/ml/intro_dl/neural_networks/RBJQM5T.jpg"></img>
  <figcaption>The photo above uses $a$ for prediction $\hat{y}$</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/ml/intro_dl/neural_networks/Untitled 7.png"></img>
  <figcaption>And that's how we eliminate one for loop which was iterating over the features for calculating derivative and updating derivatives..</figcaption>
</figure>
...
![](/assets/images/ml/intro_dl/neural_networks/Untitled 8.png)
