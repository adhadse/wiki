...
[Closures: Anonymous Functions that Capture Their Environment](https://doc.rust-lang.org/stable/book/ch13-01-closures.html){ .md-button }
...
!!! success "Why no type annotation for closure's input parameters?"
